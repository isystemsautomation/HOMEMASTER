# README Template for HOMEMASTER Modules

**Use this template to create a consistent, professional README for any HOMEMASTER hardware module.**
This document is based on the structure and detail of the ALM-173-R1 module documentation.

> ⚠️ **INSTRUCTIONS:**  
> Each section contains detailed guidance inside special comments marked like this:  
> `<!-- INSTRUCTION: Describe XYZ here -->`  
> **Replace these instructions with your actual content**, and delete the instruction markers when you're done.
...
# ALM-173-R1 Module for Alarm Systems<!-- INSTRUCTION: Insert the full product name (e.g., XYZ-123-R2 Module for Power Management) -->
...
<!-- INSTRUCTION: Briefly describe what this module does. Include key features, intended use, and supported environments. -->
...
<!-- INSTRUCTION: Fill in the subsystem table with actual specs. Adjust rows/columns to fit your module capabilities. -->
...
<!-- INSTRUCTION: Describe where and how the module connects in a system. Include controller compatibility and Modbus details. -->
...
# 2. Use Cases 🛠️
<!-- INSTRUCTION: Provide 2–5 real-world deployment examples. Use structured steps. -->
...
<!-- INSTRUCTION: Modify or confirm safety details for your hardware version. Keep structure, but adjust ratings or mounting advice. -->
...
<!-- INSTRUCTION: Update all technical specs, images, and pinouts to match your module. Be precise and clear. -->
...
<!-- INSTRUCTION: Customize register maps, function codes, and address info for your device. -->
...
<!-- INSTRUCTION: Replace with YAML and HA instructions for your module. Update diagrams and variables. -->
...
<!-- INSTRUCTION: Add real-world maintenance tasks and diagnostics tips specific to your hardware. -->
...
<!-- INSTRUCTION: Confirm license types or replace with specific license for this product. -->
...
# 11. Downloads
<!-- INSTRUCTION: List links or folder names where firmware, config tools, diagrams, manuals for this module can be found. -->
